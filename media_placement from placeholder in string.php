    ...
    if(@!empty($pg_media[1]) && @is_array($pg_media[1]))
    {
        ...
        foreach($pg_media_v as $pmk=>$pmv)
        {
            if($pmv['m_type']=='image')
            {
                ...
                $src = SITE_URL."assets/images_2/media/{$pmv['m_file']}"; ///\{media_.{3,5}?\:$pmk\}/ims
            ...
            else if($pmv['m_type']=='video')
            {
                ...
                */
                ...
                <source src=\"{$constsx['SITE_URL']}assets/images_2/media/{$pmv['m_file']}\" type=\"video/mp4\">
