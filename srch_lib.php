...
class srch_h
{
    ...
    * $operator = define the operator AND/OR of the final statement (default = AND)
    ##
    **/
    function where_it($srch_text, $table_field, $hightight_key='', $type='contains', $operator='AND')
    {
       $do = $do_par = $where = '';
       $srx = array();
