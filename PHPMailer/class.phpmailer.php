...
class PHPMailer
{
    ...
    {
        //var_dump_p($this->MIMEHeader, $this->MIMEBody); die();
        try {
    ...
    public function createBody()
    {
        ...
        $bodyBase64 = @($this->Encoding=='base64');
        ...
        switch ($this->message_type) {
            ...
            case 'alt':
                ...
                $body .= $this->encodeString($this->Body, $bodyEncoding);
                //var_dump_p($this->message_type, $this->Encoding, $bodyEncoding, $altBodyEncoding, $body); die();
                $body .= $this->LE . $this->LE;
                if (!empty($this->Ical)) {
